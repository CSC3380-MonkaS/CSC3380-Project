...
def main():
    ...
    iui.startScreen()                                        # Display the Input UI
    ...
    ufg = user_file_generator(user_prefs, user_scores)       # Make a user_file_generator object
    string_user_prefs, percents = ufg.user_file_generate()   # Generate User Info File

    oui = output_UI(percents, string_user_prefs, movie_file) # Make an output_UI object
    oui.user_movie_output()                                  # Display the output UI
